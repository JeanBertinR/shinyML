...
```
  ...
  Please note that `shinyML_regression` and `shinyML_classification` will automatically detect if you input dataset contains time-based column: train/test splitting will be adapted to time-serie forecasting. 
