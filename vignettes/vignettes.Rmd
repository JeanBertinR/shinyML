...
## Description
  ...
  `shinyML` is a Shiny application that helps you to easily compare supervised machine learning regression models. The two main fuctions of this package are `shinyML_regression` and `shinyML_classification` which leaves the choice for the user to train and test models on H2O or Spark framework. 
